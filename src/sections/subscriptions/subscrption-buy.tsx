    ...
    <>
      <Container sx={{ mt: 8 }}>
        <Stack spacing={5} sx={{ mb: 5 }}>
          ...
          <Grid sx={{ display: "flex", flexWrap: 'wrap', justifyContent: "space-evenly", mb: 3, width: "100%"}} >
            <Box sx={{
              background: `url(${Blue.src})`,
              ...
              <Box>
                ...
                <Box sx={{
                  ...
                  <Box sx={{ bgcolor: "#ffffff", border: "1px solid #757575", borderRadius: 3, width: "85%", mb: 5  }}>
                    <Grid sx={{ display: "flex", justifyContent: "center" }}>
